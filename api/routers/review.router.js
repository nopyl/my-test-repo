...
import { createReview, updateReview, deleteReview, getReviewById, getAllReviews} from "../controllers/review.controller.js";
import { checkReviewExists } from "../middlewares/query/query.middleware.js";
import { getAdminAccess, getReviewOwnerAccess } from "../middlewares/auth/auth.middleware.js";
...
reviewRouter.get("/", [isAuth, getAdminAccess], getAllReviews);